...
# directorios. Lo mantiene vivo el LaunchAgent com.fran.bibliotecario
# (RunAtLoad + KeepAlive), así que corre en segundo plano todo el rato.
#
# El acceso por http://bibliotecario (puerto 80) lo habilita aparte, con sudo,
# bibliotecario-root-setup.sh (entrada en /etc/hosts + redirección pf 80->8080).
set -euo pipefail
...
CADDYFILE="$HOME/.config/caddy/bibliotecario.Caddyfile"
